package com.repairshop.saas.marketplace.security;
...
public class JwtService {
    ...
    /**
     * Tolerant getter — customer tokens don't carry shopId. Returns null if absent or unparseable.
     */
    public UUID getShopId(String token) {
        try {
            String sid = parseClaims(token).get("shopId", String.class);
