-- =============================================================================
-- Mobile Repair Shop SaaS — Consolidated Postgres Init Schema
-- Generated by concatenating the numbered init files in order.
-- Apply with:
...
ALTER TABLE marketplace_products
    ...
    ADD COLUMN IF NOT EXISTS working_condition  VARCHAR(30),
    ADD COLUMN IF NOT EXISTS description_type   VARCHAR(30),
